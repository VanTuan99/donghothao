...
if ( ! nv_function_exists( 'nv_vinagon_ads' ) )
{
   ...
   function nv_block_config_ads_blocks ( $module, $data_block, $lang_block )
    ...
    function nv_vinagon_ads ( $block_config )
    {
        global $global_config;
    	if ( file_exists( NV_ROOTDIR . "/themes/" . $global_config['site_theme'] . "/blocks/global.ads.tpl") )
        {
        ...
        $xtpl = new XTemplate( "global.ads.tpl", NV_ROOTDIR . "/themes/" . $block_theme . "/blocks" );
...
{
    $content = nv_vinagon_ads ( $block_config );
}
