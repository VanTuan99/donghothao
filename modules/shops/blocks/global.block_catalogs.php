	...
	function html_viewsub($list_sub) {
		...
		if (empty($list_sub))
			...
			foreach ($list as $catid) {
				if ($global_array_cat[$catid]['inhome'] == '1') {$html .= "<li>\n";
					...
					if (!empty($global_array_cat[$catid]['subcatid']))
						$html .= html_viewsub($global_array_cat[$catid]['subcatid']);
					$html .= "</li>\n";
				}
			}$html .= "</ul>\n";
			return $html;
